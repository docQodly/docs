...
- New [`onInit`](../studio/pageLoaders/pageLoaderOverview.md#triggers-and-events) Event for the Page: This event is executed during the rendering phase and is used to perform any necessary setup actions when a component is first created.
...
- New [Clean Standard Action](../studio/pageLoaders/events/bindingActionToEvents.md#qodly-sources): The Clean standard action allows entity selections to be cleaned of their deleted entities, preventing blank spaces in the UI.

- Contextual Panel Update: The Contextual panel now allows function call actions to be [copied](../studio/pageLoaders/events/eventsManagement.md#copying-an-event-action) or [pasted](../studio/pageLoaders/events/eventsManagement.md#pasting-an-event-action) and called [function names to be changed post-creation](../studio/pageLoaders/events/eventsManagement.md#modifying-a-function-call), avoiding the need to delete and recreate them.

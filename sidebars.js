...
const sidebars = {
  ...
  APIReference: [
    {
      ...
      items: [
        {
          type: "autogenerated",
          dirName: "api-reference/webform-editor",
        },
      ],
    },
    // {
  ...
  Develop: [
    ...
    },
    {
      ...
      label: "Webforms",
      items: [
        "studio/design-webforms/create-webform",
        {
          type: "category",
          label: "Components",
          items: [
    ...
    },
    {
      ...
      items: ["studio/coding", "studio/debugging"],
    },
    {
      type: "category",
  ...
  ReleaseNotes: [
    {
      ...
      collapsed: false,
      items: ["notes/v1.0.0-beta.2", "notes/v1.0.0-beta.1"],
    },
  ],
};

...
- New [`onHttpGet`](../orda/data-model.md#onhttpget-keyword) function keyword to define singleton or ORDA functions that can be called through HTTP REST GET requests.

- Support of HTTP REST [GET requests](../api/classFunctionsOverview.md#function-call-syntax).

- New [`4D.OutGoingMessage`] class for the REST server to return any web contents.

...
- [Centralized Breakpoint Management Sidebar](../studio/debugging.md#breakpoints-management): A new sidebar in the code editor lets you monitor, group, enable/disable, delete, and jump to breakpoints across your entire app. No need to open files one by one—everything is now accessible in one place.

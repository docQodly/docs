...
- [QodlyEvents Class Interface](../studio/qodlyEventsClassInterface): Added structured support for defining automatic startup and shutdown logic within the QodlyEvents class.

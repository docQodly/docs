...
- New [Clean Standard Action](../studio/pageLoaders/events/bindingActionToEvents#qodly-sources): The Clean standard action allows entity selections to be cleaned of their deleted entities, preventing blank spaces in the UI.

- Contextual Panel Update: The Contextual panel now allows function call actions to be [copied](../studio/pageLoaders/events/eventsManagement#copying-an-event-action) or [pasted](../studio/pageLoaders/events/eventsManagement#pasting-an-event-action) and called [function names to be changed post-creation](../studio/pageLoaders/events/eventsManagement#modifying-a-function-call), avoiding the need to delete and recreate them.

---
id: 4d-server-architecture
title: 4D Server Architecture
---

## Overview


The Qodly platform relies on **4D Server**, a robust and powerful application development and deployment environment. 4D Server includes many features that allow you to create any type of web application, from the simplest to the most sophisticated:

- DB4D, a built-in relational database with wide capabilities,
- an HTTP server,
- a REST server with a comprehensive API, 
  
At the highest level, 4D Server includes a native support for advanced technologies that provide secured, natural and dynamic access to your data:

- Datasources, that automatically handle events on your data
- ORDA (Object Related Data Access), the data access layer providing an intuitive object-oriented API
- Qodly Script, an object-oriented language dedicated to web application.   

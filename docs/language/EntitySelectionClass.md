...
The resulting entity selection keeps the same [order criteria](../guideCenter/programmingGuide/data-model.md#ordered-or-unordered-entity-selection) and the same [alterable/shareable](../guideCenter/programmingGuide/data.md#shareable-or-alterable-entity-selections) property as the original entity selection.
...
The `.orderBy()` function <!-- REF #EntitySelectionClass.orderBy().Summary -->returns a new [ordered](../guideCenter/programmingGuide/data-model#ordered-or-unordered-entity-selection) entity selection containing all entities of the entity selection in the order specified by *pathString* or *pathObjects* criteria<!-- END REF -->.

...
|---|---|---|---|
|hostname|Text|[API Endpoint](../../cloud/apiKeys.md#api-endpoint) of the Qodly cloud instance|Name or IP address of the remote database + ":" + port number (port number is mandatory)|
|api-key|Text|[API Key](../../cloud/apiKeys.md#api-key) of the Qodly cloud instance|- (ignored)|

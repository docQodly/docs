...
<Column.List align="center" justifyContent="between">
	<Column.Item width="60%">
        <ol>
			...
			<li value="2"><strong>Define the Datasource</strong>: Specify the appropriate Datasource that contains the data you want to display within the Select Box. For instance, you can select an entity selection, such as the <code>Destination</code> dataclass.</li>
        </ol>
	</Column.Item>
	<Column.Item width="35%">

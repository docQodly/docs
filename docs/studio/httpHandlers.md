...
It is **not recommended** to expose request handler functions to external REST calls using [`exposed`](../guideCenter/programmingGuide/data-model.md#exposed-vs-non-exposed-functions) or [`onHttpGet`](../guideCenter/programmingGuide/data-model.md#onhttpget-keyword) keywords.

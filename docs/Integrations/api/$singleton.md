...
Keep in mind that only functions with the [`exposed` keyword](../../QodlyinCloud/qodlyScript/guides/data-model.md#exposed-vs-non-exposed-functions) can be directly called from REST requests.
